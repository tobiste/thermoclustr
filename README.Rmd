...
[here](https://github.com/tobiste/thermoclustr/issues) with minimal code to
reproduce the issue.

## How to cite thermoclustr

Stephan, T., Pinto, T. F., and Enkelmann, E.: Technical Note: Cluster Analysis of Inverse Thermochronology Models, EGUsphere [preprint], https://doi.org/10.5194/egusphere-2026-1279, 2026. 
