...
This is a copy of the `stat_stepribbon` function of the `ggalt` legacy
package.
...
- geom:
  ...
  character. which geom to use; defaults to `"ribbon"`
...
- direction:
  ...
  character. `"hv"` for horizontal-vertical steps, `"vh"` for
